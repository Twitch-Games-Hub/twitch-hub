...
-- CreateEnum
CREATE TYPE "GameType" AS ENUM ('BRACKET', 'BALANCE', 'PERSONALITY', 'HOT_TAKE', 'TIER_LIST', 'BLIND_TEST');
...
-- AddForeignKey
ALTER TABLE "Response" ADD CONSTRAINT "Response_sessionId_fkey" FOREIGN KEY ("sessionId") REFERENCES "GameSession"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
